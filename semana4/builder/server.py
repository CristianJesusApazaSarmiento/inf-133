...
import json
#Estandar de comunicacion de la web
# Producto: Pizza
class Pizza:
...
class PizzaHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        if self.path == '/pizza':
            ...
            HTTPDataHandler.handle_response(self, 400, {"Error": "Ruta no existente"})
