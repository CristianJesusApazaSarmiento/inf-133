...
# "animal" se maneja el controlador 
animal_bp = Blueprint("animal", __name__)

# Construyendo un CRUD
# Se tiene dos roles y ambos comparten estos permisos
# No se necesitan permisos, ya que ambos roles comparten lo mismo
...
# El role admin es el encargado de crear los objetos
